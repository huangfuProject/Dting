...
-- ----------------------------
-- Table structure for message_cpu_data
-- ----------------------------
DROP TABLE IF EXISTS `message_cpu_data`;
CREATE TABLE `message_cpu_data`  (
...
-- ----------------------------
-- Table structure for message_memory_data
-- ----------------------------
...
-- ----------------------------
DROP TABLE IF EXISTS `message_network_data`;
CREATE TABLE `message_network_data`  (
                                         `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键 自动递增',
                                         `unique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息的唯一标识，当消息群发后，标记为一批数据，唯一不为空',
                                         `message_tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息标签，标记消息的来源',
                                         `message_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标记消息的ip地址',
...
-- ----------------------------
-- Table structure for message_task_run_log
-- ----------------------------
DROP TABLE IF EXISTS `message_task_run_log`;
CREATE TABLE `message_task_run_log`  (
                                         `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键 自动递增',
                                         `unique` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息的唯一标识，当消息群发后，标记为一批数据，唯一不为空',
                                         `message_tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息标签，标记消息的来源',
                                         `message_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标记消息的ip地址',
...
-- ----------------------------
-- Table structure for message_thread_pool_data
-- ----------------------------
DROP TABLE IF EXISTS `message_thread_pool_data`;
CREATE TABLE `message_thread_pool_data`  (
                                             `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键 自动递增',
                                             `unique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息的唯一标识，当消息群发后，标记为一批数据，唯一不为空',
                                             `message_tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息标签，标记消息的来源',
                                             `message_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标记消息的ip地址',
...
-- ----------------------------
-- Table structure for message_thread_pool_detailed
-- ----------------------------
DROP TABLE IF EXISTS `message_thread_pool_detailed`;
CREATE TABLE `message_thread_pool_detailed`  (
                                                 `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键 自动递增',
                                                 `unique` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息的唯一标识，当消息群发后，标记为一批数据，唯一不为空',
                                                 `message_tag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息标签，标记消息的来源',
                                                 `message_ip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '标记消息的ip地址',
