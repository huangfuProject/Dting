...
(
    ...
    `total_use`    double(12, 2
) NOT NULL COMMENT '总使用率',
...
) ENGINE = InnoDB AUTO_INCREMENT = 816 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cpu使用率的统计信息' ROW_FORMAT = DYNAMIC;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 816 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统内存以及JVM内存的统计信息数据' ROW_FORMAT = DYNAMIC;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 816 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网卡读写数据包的统计数据' ROW_FORMAT = DYNAMIC;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '线程池的状态采集信息' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2446 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '网卡读写数据包的统计数据,详细的网卡数据' ROW_FORMAT = DYNAMIC;
...
(
    ...
    `busy_weight`      double(6, 0
) NOT NULL COMMENT '线程池忙碌的数值，计算方式为 ((活跃数/核心数) + (活跃数/最大线程数) + (队列堆积数/队列总长度))*1000',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `collect_key_index`(`collect_key`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 197 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '线程池的状态采集信息按照时间定时采集的' ROW_FORMAT = DYNAMIC;
